...
func (provider) Call(method string, raw json.RawMessage) (any, *nativeabi.Error) {
	...
	case "plugin.register", "plugin.reconfigure":
		return registration{nativeabi.SchemaVersion, map[string]any{"Name": "GitHub Copilot", "Version": "0.1.0", "Author": "unstableneutron", "GitHubRepository": "https://github.com/unstableneutron/cpa-plugins", "ConfigFields": []any{}}, map[string]any{"model_provider": true, "auth_provider": true, "executor": true, "executor_model_scope": "oauth", "executor_input_formats": []string{"chat-completions", "responses", "claude"}, "executor_output_formats": []string{"chat-completions", "responses", "claude"}}}, nil
